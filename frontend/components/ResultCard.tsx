   ...
   return (
      <section
         className={`mt-8 rounded-2xl border-2 p-6 shadow-xl md:mt-0 md:sticky md:top-24 ${
            isCKD ? "border-rose-400 bg-linear-to-br from-rose-50 to-red-50" : "border-violet-400 bg-linear-to-br from-violet-50 to-purple-50"
         }`}
         aria-live="polite"
      >
         ...
         <p className="mt-3 text-2xl font-semibold text-zinc-800">
            Estimated risk of CKD: <span className={isCKD ? "text-rose-700" : "text-violet-700"}>{riskPercent}%</span>
         </p>
